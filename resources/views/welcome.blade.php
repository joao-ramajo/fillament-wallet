...
<div class="min-h-screen bg-zinc-950 text-zinc-100 overflow-hidden">
    ...
    <header class="relative z-10 px-6 py-6 flex items-center justify-between border-b border-zinc-800">
        <h1 class="text-2xl font-black tracking-tight uppercase">Filament Wallet</h1>
        <a href="{{  route('filament.admin.pages.dashboard') }}" class="bg-zinc-100 text-zinc-950 px-5 py-2 font-bold uppercase hover:translate-x-1 hover:-translate-y-1 transition">Entrar</a>
    </header>
    ...
    <section class="relative z-10 px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16">
        <div>
            <h2 class="text-5xl md:text-7xl font-extrabold leading-none uppercase">
                Controle financeiro
                <span class="block text-lime-400">sem rodeios</span>
            </h2>
            <p class="mt-8 text-lg text-zinc-300 max-w-xl">
                O <strong>Filament Wallet</strong> é um gerenciador brutalmente honesto das suas contas.
                Registre pagamentos, recebimentos e veja o impacto real das suas decisões no saldo final.
            </p>
    ...
    <section id="features" class="relative z-10 px-6 py-24 border-t border-zinc-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div class="border-4 border-zinc-100 p-6 bg-zinc-900">
                ...
                <p class="text-zinc-300">
                    Veja quanto você <strong>espera gastar</strong> e <strong>espera receber</strong> antes do mês acabar.
                </p>
            </div>
    ...
    <!-- Footer -->
    <footer class="relative z-10 px-6 py-10 border-t border-zinc-800 text-sm text-zinc-500">
        Filament Wallet © {{ date('Y') }} — Controle financeiro sem maquiagem.
    </footer>
</div>
