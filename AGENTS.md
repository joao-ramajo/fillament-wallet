...
- Todo comando no backend deve ser executado via Laravel Sail, por exemplo `./vendor/bin/sail composer dev`, `./vendor/bin/sail composer test` e `./vendor/bin/sail composer lint:*`.
